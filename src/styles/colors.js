...
// export const PRIMARY = '#271d39';
// export const SECONDARY = '#E54982';
export const THIRD = '#E54982';
export const LIGHT = '#FFF5FA';
export const GRAY = '#727A91';
export const BLUE_LIGHT = '#CAE9FF';

export const LOGO_BACKGROUND = '#22222B';
export const RED = '#E15050';
export const RED2 = '#FD3A4A';
export const SemiCyan = '#96C9DC';
// export const GRAY = '#27272a';
export const TextColor = '#9594aa';
export const NAVBAR = '#54505e';
...
export const FOLLOW_ICON = '#E54982'; // THIRD
